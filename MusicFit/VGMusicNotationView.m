...
@implementation VGMusicNotationView
...
{
    _loaded = NO;
    NSString *bundlePath = [[NSBundle mainBundle] pathForResource:@"MusicBundle" ofType:@"bundle"];
